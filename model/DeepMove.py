...
class TrajPreAttnAvgLongUser(nn.Module):
    ...
    def forward(self, loc_emb, tim_emb, history_loc_emb, history_tim_emb, history_count, uid, target_len, batch_size):
        ...
        # print("history_loc_emb.shape: {}".format(history_loc_emb.shape))
        # print("history_tim_emb.shape: {}".format(history_tim_emb.shape))
        ...
        # print("out_state.shape: {}".format(out_state.shape))
        # print("out_state[-target_len:].shape: {}".format(out_state[-target_len:].shape))
        # print("history.shape: {}".format(history.shape))
        # print("attn_weights.shape: {}".format(attn_weights.shape))
        # print("history.reshape((1, his_len, self.hidden_size)).shape: {}".format(
        #     history.reshape((batch_size, his_len, self.hidden_size)).shape))
        ...
        # print("uid_emb.shape: {}".format(uid_emb.shape))
        # print("out.shape: {}".format(out.shape))
