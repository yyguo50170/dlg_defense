...
if __name__ == '__main__':
    ...
    parser.add_argument("--experiment_name", type=str, default='dlg_lstm_batch8', help="the name of experiment")
    ...
    parser.add_argument("--dlg_global_epoch", type=int, default=0, help="the global epoch for dlg attack")
