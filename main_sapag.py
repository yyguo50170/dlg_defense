...
from dlg_onehot import dlg_attack_onehot
from idlg import idlg_attack_onehot
from invgrad import invgrad_attack_onehot
from sapag import sapag_attack_onehot
    ...
    for er in range(args.experiment_rounds):
        ...
        for iter in range(args.global_iterations):
            ...
            if args.is_dlg == 1 and iter == 1:
                ...
                #                                   true_time=gt_data_np[:, [0]],
                #                                   )
                attack_record = sapag_attack_onehot(args,
                                                      step_size=step_size,
                                                      model=copy.deepcopy(model),
                                                      true_dy_dx=dy_dx,
                                                      idlg_attack_round=args.dlg_attack_rounds,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--experiment_name", type=str, default='sapag', help="the name of experiment")
    ...
    parser.add_argument("--experiment_rounds", type=int, default=5, help="the rounds of experiments")
    ...
    parser.add_argument("--dlg_iterations", type=int, default=1000, help="the iterations for dlg attack")
